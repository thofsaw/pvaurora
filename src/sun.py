...
# encoding: utf-8
'''
http://michelanders.blogspot.it/2010/12/calulating-sunrise-and-sunset-in-python.html
'''
...
class sun:
    ...
    import datetime
    import sunrise
    s = sun(latitude=49,longitude=3)
    print('sunrise at ',s.sunrise(when=datetime.datetime.now())
    """
    def __init__(self, latitude=52.37, longitude=4.90):  # default Amsterdam
    ...
    def __calc(self):
        ...
        longitude = self.longitude  # in decimal degrees, east is positive
        latitude = self.latitude  # in decimal degrees, north is positive
...
if __name__ == "__main__":
    s = sun(latitude=44.692665, longitude=10.965792) # Albareto
